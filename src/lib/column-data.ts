...
export const historyDpsPlayerColumns = [
  ...
  { key: 'tdps', header: 'TDPS', label: 'TDPS', description: "True DPS based on global active combat time", format: (v: number) => v.toLocaleString(undefined, { minimumFractionDigits: 1, maximumFractionDigits: 1 }) },
